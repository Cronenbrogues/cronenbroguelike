...
gary_jokes = [
    ...
    (
        10,
        [
            "\"So I tried to patent a pencil with two erasers for poor spellers like me, but I was told it was 'pointless'!\"",
    ...
    (
        20,
        [
            '"What’s the last thing to go through a fly’s head as it hits the windshield of a car doing 70? Its ass!"',
    ...
    (
        25,
        [
            '"Ha! Hahaha! Ha! Ha ha ha ha ha ha   ha     ha          ha..." Gary trails off.',
...
coffee_machine_descriptions = [
    ...
    (
        10,
        "The coffee machine gurgles angrily on the counter, which seems even wetter than usual.",
    ),
    (
        15,
        "Sleep! Work! Sleep, Work! You've done neither! Strange thoughts come unbidden to your head. Is the coffee machine glaring at you? Time for another cup!",
    ),
    (
        20,
        "From just beyond the edge of your vision, you swear you see gleaming, arachnid legs delicately manipulating a strange bundle. You turn to look, but it's just the coffee machine! You really need to get more sleep. Time for another cup!",
    ),
...
breakroom_descriptions = [
    (
        10,
        "You are in the drab company breakroom. One of the fluorescent lights is flickering a bit.",
    ),
    (
        20,
        "You are in the break room. There's a strange, faint veining on the walls now...",
    ),
    (
        30,
        "You seem to be in some kind of bio-mechanical womb. A dense convergence of fleshy, pulsing cables wrap the walls, terminating where the coffee machine once was.",
    ),
]
...
your_desk_descriptions = [
    (
        10,
        "You are sitting at your boring old desk. Someday you'll clean up the coffee stains.",
    ),
    (
        20,
        "You are sitting at your boring old desk. You're pretty sure one of the coffee stains just blinked at you.",
    ),
    (
        30,
        "There is a strange organic growth where your desk once was. It seems to be breathing.",
    ),
]
...
office_computer_descriptions = [
    ...
    (
        15,
        "Your computer hums gently in front of you. It looks a bit... sharper than usual?",
    ),
    (
        25,
        "Your computer hums gently in front of you. Well, not a hum, really - more of a gurgling growl.",
    ),
    (29, "Your computer growls menacingly."),
    (
        30,
        "A fleshy tentacle undulates gently where your computer once was. A wicked claw emerges at the level of your forehead.",
    ),
]
...
meeting_room_descriptions = [
    ...
    (
        20,
        "You are in the meeting room. It smells like blood, sweat, and tears. Must be some weird motivational scent?",
    ),
    (25, "You are in the meeting room. It smells of shit and putrid flesh."),
    (
        30,
        "You think this must have been the meeting room. There's a heap of twisted bodies, viscous with some kind of pale ooze, writhing orgiastically on the floor.",
    ),
]
...
copier_room_descriptions = [
    ...
    (
        30,
        "You think this was once the copy room. There is a bin full of moaning bodies. They all seem to be Gary.",
    ),
]
...
copier_descriptions = [
    ...
    (
        20,
        "The office's byzantine copier looks to be broken again. You smack it reproachfully.",
    ),
